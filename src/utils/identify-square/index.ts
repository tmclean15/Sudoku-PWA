...
/**
 * Identifies and returns the current working square of a given sudoku grid at a row and column index
 * @param input Object with 9x9 grid, column index, and row index
 */
